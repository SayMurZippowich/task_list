...
CREATE TABLE `tasks` (
  ...
  KEY `tasks_performer_id_foreign` (`performer_id`),
  KEY `tasks_task_status_id_foreign` (`task_status_id`),
  CONSTRAINT `tasks_creator_id_foreign` FOREIGN KEY (`creator_id`) REFERENCES `users` (`id`),
  CONSTRAINT `tasks_performer_id_foreign` FOREIGN KEY (`performer_id`) REFERENCES `users` (`id`),
...
-- Dump completed on 2020-07-07  9:41:32
